...
## Implementar botão cancelar onda em /picking - 24/02/2026
- [x] Criar endpoint backend para cancelar onda
  - [x] Validar se onda pode ser cancelada (status permitidos: pending, picking)
  - [x] Reverter quantidades separadas (zerar pickedQuantity)
  - [x] Atualizar status da onda para "cancelled"
  - [x] Liberar pedidos (voltar para pending, manter reservas)
  - [x] Validar permissão (apenas admin/manager)
- [x] Adicionar botão "Cancelar Onda" no frontend
  - [x] Botão condicional para ondas com status "picking"
  - [x] Confirmação nativa com aviso de perda de progresso
