...
## Fase: Implementação de Ondas de Picking
- [ ] Adicionar tabs (Pedidos e Ondas) na página PickingOrders.tsx
- [x] Implementar procedure backend picking.getPickingProgress
